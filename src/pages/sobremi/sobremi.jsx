...
function Sobremi() {
    ...
    document.addEventListener("DOMContentLoaded", function() {
        ...
        "Me encantaría invitarlo(a) a revisar mi currículum y conocer más acerca de mi experiencia. \n\n"+
    ...
    // var lineHeight = 20;  // Espacio vertical entre líneas
    // var y = light.y;  // Posición vertical inicial
  ...
  var lineHeight = 30; // Espacio vertical entre líneas
  var textY = light.y - (lines.length * lineHeight) / 2 + 120; // Posición vertical inicial

  for (var i = 0; i < lines.length; i++) {
    ctx.fillText(lines[i], light.x, textY); // Dibujar cada línea
    textY += lineHeight; // Actualizar la posición vertical para la siguiente línea
  }
